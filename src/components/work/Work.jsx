...
export const Work = () => {
	...
	const handleSubmit = async (e) => {
		...
		const data = await axios.post(`${API}/workmail`, { name, workname, email })
					...
					<div key = {index} className="bg-gray-800 text-gray-50 pb-8">
						<div className="container grid grid-cols-12 mx-auto bg-gray-900">
							...
							<div className="flex flex-col p-6 col-span-full row-span-full lg:col-span-8 lg:p-10">
								...
								<button onClick={handleSubmit} type="submit" value={work.title} name="workname"  clasName="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Apply here</button>
