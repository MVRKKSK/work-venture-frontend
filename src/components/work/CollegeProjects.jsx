...
export const CollegeProjects = () => {
	...
	useEffect(() => {
		const getWorkData = async () => {
			const  {data}  = await axios.post(`${API}/getPostsbyCollege` , {
                college : college
            });
			setWorkData(data);
		};
					...
					<div className="dark:bg-gray-800 dark:text-gray-50 pb-8">
						<div className="container grid grid-cols-12 mx-auto dark:bg-gray-900">
							...
							<div className="flex flex-col p-6 col-span-full row-span-full lg:col-span-8 lg:p-10">
								...
								<a rel="noopener noreferrer" href={work.link} className="inline-flex items-center pt-2 pb-6 space-x-2 text-sm dark:text-green-400">
